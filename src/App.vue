        ...
        >
          <ul class="navFlex__list">
            <li class="navFlex__item">
              <a class="navFlex__text" href="https://www.statista.com/">Home</a>
            </li>
            <li class="navFlex__item">
              <a class="navFlex__text" href="https://www.statista.com/aboutus/"
                >About Statista</a
              >
            </li>
            <li class="navFlex__item">
            ...
            <li class="navFlex__item">
              <a class="navFlex__text" href="https://www.statista.com/contact/"
                >Contact</a
              >
            </li>
            <li class="navFlex__item">
              <a class="navFlex__text" href="https://www.statista.com/help/"
                >Help &amp; FAQ</a
              >
            </li>
            <li class="navFlex__item">
